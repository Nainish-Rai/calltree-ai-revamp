...
export default function Page() {
    return (
        <div className="w-full min-h-screen bg-white text-forest-800 overscroll-behavior-y-contain bg-none">
            {' '}
            <Script
                id="reb2b-script"
            ...
            <div className="max-w-7xl mx-auto px-6 pt-32 pb-[164px]">
                {' '}
                <div className="text-center flex flex-col items-center justify-center max-w-5xl mx-auto mb-[156px]">
                    {' '}
                    <HeroTitle />{' '}
                    <p className="text-xl md:text-2xl text-forest-600 max-w-3xl mb-12 font-light text-center">
                        Calltree provides enterprise-grade AI support agents that handle customer
                        interactions exactly like your human agents—reducing contact center
                    ...
                    <div className="flex items-center gap-4 justify-center">
                        ...
                        <a
                            ...
                            className="bg-sage-500 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-sage-600 transition-colors"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            {' '}
                            Book a meeting{' '}
                            <ArrowRightIcon className="inline-block ml-1 w-4 h-4" />{' '}
                        </a>{' '}
                    </div>{' '}
                </div>{' '}
                            ...
                            <div className="justify-start items-start grid grid-cols-1 md:grid-cols-3 gap-[52px]">
                                ...
                                >
                                    ...
                                    <p className="text-forest-600 text-balance">
                                        ...
                                        efficiency over time—without extra effort from your
                                        team.{' '}
                                    </p>{' '}
                                </motion.div>{' '}
                            </div>{' '}
