...
export const GeminiEffect = ({
    ...
    return (
        <div className={cn('sticky top-80', className)}>
            <p className="text-3xl md:text-4xl lg:text-5xl  text-[#252525]  mb-6 tracking-tight leading-tight mx-auto text-center">
                {title || `Ready to Scale Your Contact Center with AI Agents?`}
            </p>
            <p className="max-w-2xl text-base lg:text-lg  text-[#575757]  font-normal   mb-12 leading-relaxed opacity-90 mx-auto text-center">
                {description ||
